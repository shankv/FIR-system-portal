...
<div class="login" style="width:600px;">
		  ...
		  <div class="login-triangle" style="margin-top:-30px;"></div>
		    <h2 class="login-header" style="height:10px;">Step-2</h2>
    
		<form:form action="saveMissing" modelAttribute="missing"  class="login-container">

			<!-- need to associate this data with customer id -->
			<form:hidden path="id" />
					 
					 <p><form:input path="name" type="text"   placeholder="Name*"/>
						 <form:errors path="name" cssClass="error"/></p>
						 
				   <p style="display:block;">Gender:<form:radiobutton path="gender" value="Male" label="Male" />
					<form:radiobutton path="gender" value="Female" label="Female" />
					<form:errors path="gender" cssClass="error"/></p>
					
				    <p><form:input path="age" type="text"   placeholder="age*"/>
						 <form:errors path="age" cssClass="error"/></p>		
						 
				   <p><form:input path="dob" type="text"   placeholder="Date Of Birth*"/>
						 <form:errors path="dob" cssClass="error"/></p>	
						 
				   <p><form:input path="adharNo" type="text"   placeholder="Adhar No*"/>
						 <form:errors path="adharNo" cssClass="error"/></p>		
				   <p><form:input path="missingDate" type="text"   placeholder="Missing Date*"/>
						 <form:errors path="missingDate" cssClass="error"/></p>	
						 
				 <p><form:input path="missingTime" type="text"   placeholder="Missing Time*"/>
						 <form:errors path="missingTime" cssClass="error"/></p>	
						 
				 <p><form:input path="missingPlace" type="text"   placeholder="Missing Place"/>
						 <form:errors path="missingPlace" cssClass="error"/></p>
						 
				 <p><input type="submit" value="Submit FIR"></p>		 				 			 			 		 			  
