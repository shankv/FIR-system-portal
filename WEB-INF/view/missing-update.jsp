...
function copyValue(){
	   ...
	   var dropboxvalue = document.getElementById('myList').value;
	   document.getElementById('aaaa').value = dropboxvalue;
...
<div class="login" style="width:600px;">
		...
		<form:form action="saveUpdate" modelAttribute="missing"  class="login-container">

			<!-- need to associate this data with customer id -->
			<form:hidden path="id" />
					 
					dgh <p class="chota"><form:input path="name" type="text"   placeholder="Name" readonly="true"/>
				 ...
				 ghjgb  <p class="chota" ><form:input path="adharNo" type="text"   placeholder="Adhar No" readonly="true"/>
				...
				<p><form:input path="status" type="text"  id="aaaa" placeholder="status" />
				      select from here:
					   <select id = "myList" onchange="copyValue()">
				 ...
				 <p><form:input path="discription" type="text"   placeholder="Discription"/>
